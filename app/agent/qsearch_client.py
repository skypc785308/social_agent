...
def post_json(url, key, body):
    ...
    headers = {
        ...
        "User-Agent": "Mozilla/5.0 (compatible; QSearchBot/1.0)"
    }
    req = Request(full_url, data=data, headers=headers, method="POST")
    try:
...
def to_unix_end(date_str):
    """Convert YYYY-MM-DD to Unix timestamp at the end of the day."""
